    ...
    public partial class Form9 : Form
    {
        ...
        void FillCombo()
        {
            ...
            while (myreader.Read())
            {
                ...
                string u = myreader["productsID"].ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con9.Open();
            string s1 = "Select *From dbo.Products_New where productsID = '" + comboBox1.Text.ToString() + "'";

            SqlCommand cmd9 = new SqlCommand(s1, con9);
            ...
            // while (myreader.Read())
            // {
            //  u = myreader["productsID"].ToString();
            // aaa[i] = u;
            // i = i + 1;
            ...
            //MessageBox.Show(aaa[j].ToString());//if (u == textBox1.Text.ToString())
            //String.Equals(aaa[j].ToString(), textBox1.Text)

            //if (string.Compare(aaa[j].ToString(), textBox1.ToString()) ==0)
            // if (aaa[j].ToString().CompareTo(textBox1.Text) == 0)
            // if(aaa[j].ToString()== (textBox1).ToString())
            // if ((textBox1).Text == s)
            //  {
            // MessageBox.Show("rrrrrrrrrrrrrrrrrrrr");
            try
            {

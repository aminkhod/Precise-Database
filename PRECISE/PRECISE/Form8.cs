    ...
    public partial class Form8 : Form
    {
        ...
        void FillCombo()
        {
            ...
            while (myreader.Read())
            {
                ...
                string u = myreader["product"].ToString();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(conString);
            con.Open();
            String q = "Select *From dbo.Products_New where product = '" + comboBox1.Text.ToString() + "'";

            SqlCommand cmd = new SqlCommand(q, con);

            SqlDataReader myreader = cmd.ExecuteReader();
            // string u1="",u2="", u1 = "", u2 = "", u1 = "", u2 = "",u1="",u2="",;
            string[] aaa = new string[7];
            while (myreader.Read())
            {
                aaa[0] = myreader["productsID"].ToString();
                aaa[1] = myreader["SubGroup_Name"].ToString();
                aaa[2] = myreader["Group_Name"].ToString();
                aaa[3] = myreader["product"].ToString();
                aaa[4] = myreader["Unit_cost_USD"].ToString();
                aaa[5] = myreader["UAE_RRP_AED"].ToString();
                aaa[6] = myreader["QAR_RRP_QAR"].ToString();
            }
        ...
        {
            SqlConnection con10 = new SqlConnection(conString);
            con10.Open();
            string s1 = "Select *From dbo.Products_New where product = '" + comboBox1.Text.ToString() + "'";

            SqlCommand cmd9 = new SqlCommand(s1, con10);

    ...
    public partial class Form12 : Form
    {
        ...
        void FillCombo()
        {
            ...
            while (myreader.Read())
            {
                ...
                string u = myreader["SubGroup_Name"].ToString();
                lll.Add(u);
        ...
        {
            SqlConnection con12 = new SqlConnection(conString);
            con12.Open();
            string s1 = "Select *From dbo.Products_New where SubGroup_Name = '" + comboBox1.Text.ToString() + "'";

            SqlCommand cmd9 = new SqlCommand(s1, con12);
